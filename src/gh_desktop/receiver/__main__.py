"""CLI entry point for the webhook receiver: `gh-desktop-receiver`."""
...
def main() -> None:
    _configure_logging()
    parser = argparse.ArgumentParser(prog="gh-desktop-receiver")
    ...
    if args.gen_secrets:
        ...
        print(f"GH_DESKTOP_RECEIVER_WEBHOOK_SECRET={secrets.token_hex(32)}")
        print(f"GH_DESKTOP_RECEIVER_SUBSCRIBER_TOKEN={secrets.token_urlsafe(32)}")
        return
